...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description='Batch-run simple clustering baselines on multiple datasets.'
    )
    parser.add_argument(
        '--python',
    ...
    parser.add_argument(
        '--base-out-dir',
        default=(
            '/disk/fanjunming/home/workspace/bioinfo/scRGCL/baseline/results/'
            'batch_simple_baselines'
        ),
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help='Manual resolution override shared across datasets.',
    )
    ...
    parser.add_argument(
        ...
        help=(
            'Optional subset of dataset IDs to run. Default: all IDs in '
            'DATA_DICT.'
        ),
    )
...
def main() -> None:
    ...
    print(
        f'\nBatch run finished. success={success_count}, '
