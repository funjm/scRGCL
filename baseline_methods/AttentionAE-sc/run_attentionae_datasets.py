#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Batch run AttentionAE-sc on a fixed set of datasets.

Usage examples:
  python run_attentionae_datasets.py --datasets all
  python run_attentionae_datasets.py --datasets 0,9,11
  python run_attentionae_datasets.py --datasets Quake_10x_Bladder,Pollen
"""
...
def main():
    ...
    print(f'Running AttentionAE-sc for {len(datasets)} dataset(s): {datasets}')
    failed_datasets = []
    for ds in datasets:
