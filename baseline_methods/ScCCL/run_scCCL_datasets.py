...
def main():
    ...
    parser.add_argument('--script', default='/home/fanjunming/workspace/bioinfo/scRGCL/baseline_methods/ScCCL/main.py', help='Path to the ScCCL entry script')
    parser.add_argument('--out-dir', default='/home/fanjunming/workspace/bioinfo/scRGCL/baseline/results/ScCCL', help='Directory for per-run metrics, predictions, embeddings, and summary files')
