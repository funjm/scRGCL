...
def main():
    ...
    parser.add_argument('--script', default='/home/fanjunming/workspace/bioinfo/scRGCL/baseline_methods/scSAMAC-cluster/run_scSAMAC.py', help='Path to the scSAMAC entry script')
    parser.add_argument('--out-dir', default='/home/fanjunming/workspace/bioinfo/scRGCL/baseline/results/scSAMAC-cluster', help='Directory for per-run metrics, predictions, embeddings, and summary files')
